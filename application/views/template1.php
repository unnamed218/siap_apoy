...
<html lang="en">
 ...
 <!-- <link rel="icon" href="<?php echo base_url();?>assets/images/favicon-32x32.png" type="image/ico" /> -->
  ...
  <body class="login" style="background-image: url(<?php echo base_url();?>assets/images/favicon-32x32.png); height: 98%; background-position: center; background-repeat: no-repeat; margin-top: 20%">
    <body class="login">
    <div>
...
<hr>
           ...
           <form method = "POST" action = "<?php echo site_url('c_login/cek_login');?>">
              ...
              <div class="separator">
                ...
                <div>
                  <!-- <h1 style="font-size: 35px"> Bangnana Chips!</h1> -->
                  <p>©2019 Zulfikri Fahrudin</p>
                </div>
              </div>
            </form>
          </section>
